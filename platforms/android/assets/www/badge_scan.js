...
var badgeapp = {
    ...
    onDeviceReady: function() {
        badgeapp.receivedEvent('deviceready');
    },
    ...
    receivedEvent: function(id) {
		...
		var ref = window.open('https://m-dot-betaspike.appspot.com/rpc/playerUndecorated/getPlayerProfile?json=', '_blank', 'location=no');
